        ...
        <main className="calm-main" style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto' }}>
          ...
          {!activeTab && (
            <>
              ...
              {/* Removed the "Understanding Mental Health" section as requested */}
              ...
              >
                ...
                <div className="relative z-10 text-center text-white">
                  ...
                  <p className="text-lg mb-8">
                    Your personal mental health assistant, always here to help.
                  </p>
                  <button 
                    className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105"
                    onClick={() => navigate('/refer-patient')}
                  >
                    Refer a Patient
                  </button>
                </div>
